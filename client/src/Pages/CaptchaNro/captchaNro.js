...
import captcha2 from "../../assets/images/captcha2.png";
import Header from "../../Components/Header/Header";
import Footer from "../../Components/Footer/Footer";

function CaptchaNro() {
  const { isLoading, CaptchaNro, CaptchaMonth } = useSelector(
    (state) => state.getData
  );
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      await Promise.all([
        getCaptchaNro(dispatch),
        getCaptchaNroCombo(dispatch),
      ]);
    };
    getData();
  }, [dispatch]);
                  ...
                  CaptchaNro.map((item, index) => (
                    ...
                    >
                      <div className="item-info">
                        <img src={captcha2} alt="img" />
                        <span style={{ fontSize: 16 }}>
                          gói captcha {item.title}đ
                        </span>
                        <br />
              ...
              <ul className="item-list">
                ...
                {!isLoading &&
                  CaptchaMonth.map((item, index) => (
                    ...
                    >
                      <div className="item-info">
                        <img src={captcha} alt="img" style={{ height: 164 }} />
                        <span style={{ fontSize: 16 }}>
                          Solve Captcha {item.title} máy
                        </span>
                        <br />
                        <span style={{ color: "green" }}>
                          Giá: {formatNumber(item.price)}đ/1 tháng
                        </span>
                        <br />
                        <span>
                          <FontAwesomeIcon icon={faCheckCircle} /> Tiết kiệm
